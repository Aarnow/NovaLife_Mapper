Mapper
Description : Plugin Nova-Life qui offre quelques fonctionnalités pour vous aider dans la décoration de votre serveur, mais aussi pour vous permettre de partager ou d'importer des décorations avec l'ensemble de la communauté.

Licence
Ce projet est distribué sous la licence GNU General Public License (GPL) version 3. Vous pouvez consulter le texte complet de la licence dans le fichier LICENSE.
...
Utilisation
Vous pouvez retrouver la dernière release de ce projet ainsi qu'un wiki
